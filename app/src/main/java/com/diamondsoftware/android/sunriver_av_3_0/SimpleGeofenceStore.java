...
public class SimpleGeofenceStore {
    ...
    public SimpleGeofence getGeofence(String id) {
    	...
    	/*
    	 * Get the Name for the geofence identified by id, or NULL if it doesn't exist
    	 */
        ...
        if (
            ...
            return new SimpleGeofence(id, lat, lng, radius, expirationDuration, transitionType,name);
    ...
    public void setGeofence(String id, SimpleGeofence geofence) {
        ...
        editor.putString(
        		getGeofenceFieldKey(id, GeofenceUtils.KEY_NAME), geofence.getName());
